                ...
                <div className="container mx-auto text-center">
                    ...
                    <div className="w-full overflow-hidden relative">
                        <div className="flex-wrap flex space-x-1 justify-center gap-5">
                            {SkillsList.map((item) => (
                                <div key={item.id} className="text-xl text-black bg-gray-300 px-5 py-2 rounded flex justify-center items-center hover:bg-gray-500 hover:text-white hover:border ">
                                    {/* <div> */}
