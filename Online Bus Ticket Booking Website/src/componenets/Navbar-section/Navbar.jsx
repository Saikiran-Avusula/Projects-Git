                ...
                <div className="w-full h-full flex items-center justify-between">
                    ...
                    <div className={`${openMenu ? "flex absolute top-20 left-0 w-full h-auto md:relative" : "hidden"} flex-1 md:flex flex-col md:flex-row md:gap-14 gap-8 md:items-center items-start md:p-0 sm:p-4 justify-end md:bg-transparent bg-neutral-50 border md:border-transparent border-neutral md:shadow-none sm:shadow-md shadow-md rounded-xl`}>
                        ...
                        <div className="flex flex-center justify-center m-2">
                            <button className="md:w-full w-full md:px-4 px-2.5 py-1 bg-red-500 hover:border-red-500 border border-red-500 md:rounded-full rounded-xl text-white font-normal text-neutral-50 hover:text-red-500 hover:bg-white ease-in-out duration-300">
                                Sign Up
                            </button>
