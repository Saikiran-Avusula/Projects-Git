...
const BusSeat = () => {
    ...
    const handleSeatClick = (seatId) => {
        ...
        setSelectedSeats((prevSelectedSeats) => {
            // cheeck if seat is alredy selected
            if (prevSelectedSeats.includes(seatId)) {
                // and alsoe make the vice verse . or de-select 
            ...
            // show error if more than 10 seats are selected
                ...
                if (prevSelectedSeats.length >= 10) {
                    setShowError(true);
                    return prevSelectedSeats; //dont select seat more than  10
                } else {
                ...
                <div className="w-full space-y-2">
                    ...
                    <div className="space-y-0 5 w-full">
                        <div className="w-full flex items-center justify-between gap-x-5">
                            ...
                            <p className="text-sm text-neutral-400 font-noraml">
                                From <span className="text-xs">(Chakchae)</span>
                            </p>
                        </div>
